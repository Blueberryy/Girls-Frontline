...
brawl.config.playerModels = {
	...
	[1] = {
		...
		"models/player/closers_sylvi_union_agent.mdl",
		"models/player/dewobedil/kancolle/akitsu_maru/default_p.mdl",
		"models/player/closers_tina_vulture_corp_operative.mdl",
		"models/player/closers_tina.mdl",
		"models/pacagma/kancolle/bismarck/bismarck_player.mdl",
		"models/player/girls_frontline_ump45.mdl",
		"models/player/dewobedil/kancolle/u511/default_p.mdl",
		"models/pacagma/touhou/seiran/seiran_player.mdl",
		"models/pacagma/touhou/ringo/ringo_player.mdl",
